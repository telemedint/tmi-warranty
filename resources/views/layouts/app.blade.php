...
<head>
    ...
    <title>{{ config('app.name', 'Clients and Devices') }}</title>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('clients.index') }}">@lang('translation.clients')</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('devices.index') }}">@lang('translation.devices')</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('categories.index') }}">@lang('translation.categories')</a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('photos.index') }}">@lang('translation.photos')</a>
                        </li>
